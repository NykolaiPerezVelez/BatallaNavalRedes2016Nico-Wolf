...
public class TableroFlota extends Tablero
{
     ...
     * 
     * Buque - Resistencia 3 <br>
     * Buque - Resistencia 3 <br>
     * 
     * Lancha - Resistencia 1 <br>
     * Lancha - Resistencia 1 <br>*/
    ...
    public void inicializarBarcosTablero( )
    {
        ...
        desplegarBarco( new Barco( "Buque", 3, new Color( 100, 70, 70 ) ) );
        desplegarBarco( new Barco( "Buque", 3, new Color( 100, 70, 70 ) ) );
        desplegarBarco( new Barco( "Lancha", 1, new Color( 70, 100, 70 ) ) );
        desplegarBarco( new Barco( "Lancha", 1, new Color( 70, 100, 70 ) ) );
        verificarInvariante( );
    }
    ...
    private boolean verificarBarcoCabe( int fila, int columna, int orientacion, int largo )
    {
        ...
        if( orientacion == HORIZONTAL && columna + largo >= 15 )
            return false;

        if( orientacion == VERTICAL && fila + largo >= 15 )
            return false;
    ...
    {        
        ...
        for( int k = 0; k < barcos.size( ); k++ )
        {
            ...
            for( int i = 0; i < 15 && !encontreBarco; i++ )
            {
                for( int j = 0; j < 15 && !encontreBarco; j++ )
                {
