...
public class PanelTableros extends JPanel implements ActionListener
{
     ...
     * Color para las casillas que fueron atacadas pero que no le dieron a nada
     */
    private static final Color COLOR_ATACADA = new Color( 253, 100, 70 );
    ...
    {
        botonesJugador = new JButton[15][15];
        botonesOponente = new JButton[15][15];

        JPanel panelJugador = new JPanel( new GridLayout( 15, 15 ) );
        JPanel panelOponente = new JPanel( new GridLayout( 15, 15 ) );

        panelJugador.setPreferredSize( new Dimension( 35 * 15, 35 * 15 ) );
        panelOponente.setPreferredSize( new Dimension( 35 * 15, 35 * 15 ) );
